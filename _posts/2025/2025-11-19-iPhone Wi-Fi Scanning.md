...
### Historical data
To determine the first appearance of the `[corewifi] AUTO-JOIN: -- <redacted> - ssid=<redacted>`scan log, I extracted the full Apple Unified Logs on 19 November around 10:30 AM. The earliest entry in the AUL was from 3 November, but the first scan result appeared on 18 November at 07:19 AM.
